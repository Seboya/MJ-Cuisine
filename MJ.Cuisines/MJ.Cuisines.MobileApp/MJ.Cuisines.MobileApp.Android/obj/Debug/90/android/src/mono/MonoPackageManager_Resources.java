...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "MJ.Cuisines.MobileApp.Android.dll" comes first in this list. */
		"MJ.Cuisines.MobileApp.Android.dll",
		"DryIoc.dll",
		"FFImageLoading.dll",
